              ...
              child: ConstrainedBox(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // Multiple Appointments Header & Switcher Chips
                      if (allBookings.length > 1) ...[
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              'Showing ${_selectedIndex + 1} of ${allBookings.length}',
                              style: const TextStyle(
                        ...
                        // Horizontal Selector for appointments
                        SizedBox(
                          height: 42,
                          child: ListView.separated(
                                ...
                                label: Row(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      height: 6,
                                      decoration: BoxDecoration(
                                        color: b.status.toLowerCase() == 'approved'
                                            ? AppColors.success
                                    ...
                                    Text(
                                      b.eventType.isNotEmpty ? b.eventType : b.referenceCode,
                                      maxLines: 1,
